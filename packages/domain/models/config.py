...
class ORMConfigSnapshot(Base):
    ...
    # T6.1 (stage 5): research proxy section (§5.12) — the only
    # network egress; sealed by bootstrap
    research_proxy: Mapped[JsonDict | None] = mapped_column(JSONB, nullable=True)
