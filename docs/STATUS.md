...
дефолты движка, обоснование там), корпус v2 без изменений, риски
(обрыв JSON у куратора — 1/3 сессий в SMOKE-HALOGEN2, не чинится) и
оценка N под halogen (n=3 — планировочный диапазон). Решение о запуске
и объёме серии — за пользователем.
