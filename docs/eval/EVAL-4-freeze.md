...
5. **Модельные as_of-артефакты** (ADR-0008 §3.5: 4 из 8 due в EVAL-3d —
   ...
   следствие ADR-0007, не меняется. **Уточнение 2026-09-22**: в EVAL-4d — 16 из 22 просроченных; вместе с 6
   заложенными по дизайну они делают g6 red даже без артефактов при N ≤ 29 —
   расчёт и предрегистрация в §3.1.
