...
**Задачи T7.8–T7.15** (дефекты, найденные оценкой EVAL-3b — работа над системой по §22.2,
не разовые правки): постмортем — `docs/eval/EVAL-3b-postmortem.md`; правки — логическая
последовательность PR'ов T7.8 → T7.14, затем E2E-валидация T7.15. Замороженный корпус,
