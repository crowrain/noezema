...
**Задачи T7.8–T7.16** (дефекты, найденные оценкой EVAL-3b — работа над системой по §22.2,
не разовые правки): постмортем — `docs/eval/EVAL-3b-postmortem.md`; правки — логическая
последовательность PR'ов T7.8 → T7.14, E2E-валидация T7.15, остаточный дефект выбора фрагмента T7.16. Замороженный корпус,
конфиги v2/v3 и пороги §22.2 не меняются (хэши прежние); новый прогон не планируется до
